...
namespace VersionsAggregation
{
    public class Program
    {
        static void Main()
        {
            ...
            string versionsFolderPath = @"";
            string localPath = "";
            string localFolderName = "Operation"; 
            #endregion
            ...
            string[] versionDirectories = Directory.GetDirectories(versionsFolderPath);
                        ...
                        foreach (string database in databases)
                        {
                            ...
                            foreach (string databaseSubDirectory in databaseSubDirectoriesSrc)
                            {
                                ...
                                foreach (string subDirectoryFile in subDirectoryFiles)
                                {
                                    ...
                                    if (File.Exists(subDirectoryFileDestinationPath))
                                        File.Delete(subDirectoryFileDestinationPath);
                                    File.Move(subDirectoryFile, subDirectoryFileDestinationPath);
                                }
                            }
                            #endregion
                            ...
                            foreach (string databaseFile in databaseFiles)
                            {
                                ...
                                File.Move(databaseFile, fileDestinationPath);
                            }
                            #endregion
                        }
